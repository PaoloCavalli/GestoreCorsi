...
public class FXMLController {
    ...
    @FXML
    private Button btnDivisioneStudentis;
  ...
  for(Corso c : statistiche.keySet()) {
    ...
    void initialize() {
        ...
        assert btnDivisioneStudentis != null : "fx:id=\"btnDivisioneStudentis\" was not injected: check your FXML file 'Scene.fxml'.";
